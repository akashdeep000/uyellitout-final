        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Signup with credentials or with your Apple or Google account
                    </CardDescription>
                </CardHeader>
                {success ?
                    <div className="text-center p-6 pt-0">Account created successfully <b /> Please check your email for verification</div>
                    :
                    <CardContent>
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                <div className="grid gap-6">
                                    <div className="flex flex-col gap-4">
                                        <Button type="button" variant="outline" className="w-full hidden">
