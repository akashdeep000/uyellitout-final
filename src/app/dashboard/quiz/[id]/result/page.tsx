...
export default function Page() {
    ...
    return (
        <div className="fixed sm:rounded-lg rounded-none sm:relative z-[500000] sm:z-[50] top-0 left-0 w-full h-full bg-[#9ed6b7] flex flex-col">
                        ...
                        <div className="h-full max-w-md mx-auto flex flex-col justify-center gap-8">
                            ...
                            <div>
                                <p className="text-2xl text-gray-800 font-semibold tracking-tighter">
                                    You’re generally doing well, but regular check-ins with yourself are important for long-term well-being.
                                </p>
                            </div>
                        </div>
                    </CarouselItem>
                    <CarouselItem className="h-full p-4 pl-8">
                        <div className="h-full max-w-md mx-auto flex flex-col justify-center gap-8">
                            ...
                            <div className="text-gray-800 tracking-tighter space-y-4">
                                <p className="text-xl">
                                    You might not be experiencing significant mental health challenges, but it’s still helpful to maintain a routine of self-care, mindfulness, and stress management.
                                </p>
                                <p className="text-2xl">
                                    Therapy can help you improve your overall well-being and provide preventative support.
                                </p>
                            </div>
                        </div>
                    </CarouselItem>
            ...
            <div className="p-2 flex gap-1 justify-between sm:justify-around items-center">
