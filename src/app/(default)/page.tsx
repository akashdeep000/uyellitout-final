        ...
        <main>
                    ...
                    <div className="absolute top-0 bottom-0 left-0 right-0 flex flex-col">
                        ...
                        <div className="flex-1 hidden p-6 xl:grid grid-cols-[auto_1fr_auto] gap-6 place-items-center">
                            <motion.div transition={{
                                ...
                                <p className="text-white text-xl text-right">Not sure <br /> if you <br /> need <br /> therapy?</p>
            ...
            <div className="flex gap-4 py-16 px-6 justify-around bg-emerald-300/80">
                <div className="flex gap-6 text-2xl break-words">
                    <p>
                        <motion.span onViewportEnter={() => sessionsSpring.set(750)} onViewportLeave={() => sessionsSpring.set(162)} className="text-4xl font-bold">{sessionsCount}</motion.span>{" "}
                        Sessions
                    </p>
                    <p>
                        <motion.span onViewportEnter={() => clientsSpring.set(125)} onViewportLeave={() => clientsSpring.set(114)} className="text-4xl font-bold">{clientsCount}</motion.span><span className="text-4xl pl-1 pr-2">+</span>
                        Happy clients
                    </p>
                </div>
            </div>
