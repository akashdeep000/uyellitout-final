...
export default function Home() {
  const sessionsSpring = useSpring(168, {
    mass: 0.8,
    stiffness: 75,
    damping: 15,
  });
  ...
  const clientsSpring = useSpring(34, {
    mass: 0.8,
    stiffness: 75,
    damping: 15,
  });
  ...
  const features = [
    {
      ...
      description:
        "Access therapy anytime, anywhere from your phone or computer.",
      our: true,
      others: false,
    },
    {
      title: "24/7 Support",
      description:
        "Get round-the-clock chat support to address urgent concerns.",
      our: true,
      others: false,
    },
    {
    ...
    },
    {
      ...
      description:
        "Transparent and affordable pricing without travel expenses.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "High-quality, face-to-face therapy through video calls with therapists",
      our: true,
      others: false,
    },
    {
      title: "Chat Sessions",
      description:
        "Anonymous, text-based therapy for those who prefer written communication.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Voice-based therapy for those who prefer talking without video or text.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Save time and money by attending sessions from the comfort of your home.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Engage with quizzes, blogs, and tools to complement your therapy journey.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Personalized strategies and follow-ups tailored to your needs.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Digital reminders, session notes, and tools to track your progress.",
      our: true,
      others: false,
    },
    {
      ...
      description:
        "Get a detailed progress report after each session to see your growth over time.",
      our: true,
      others: false,
    },
  ];
      ...
      questions: [
        {
          ...
          answer:
            "Counseling is a process where a professional helps individuals work through personal challenges, mental health issues, emotional distress, or life changes by providing guidance and support.",
        },
        {
          question: "What types of counseling do you offer?",
          answer:
            "We offer a wide range of counseling services, including <b>individual therapy, couples therapy, family therapy, parental counseling, child and teen counseling, and more</b>, tailored to each individual's or family’s needs.",
        },
        {
          question: "Why should I seek counseling?",
          answer:
            "Counseling is beneficial if you are dealing with emotional difficulties, stress, anxiety, relationship issues, grief, or any other life challenge. It provides you with a safe space to talk, reflect, and gain coping strategies.",
        },
        {
          question: "How do I know if therapy is right for me?",
          answer:
            "Therapy is for anyone who wants to understand themselves better, improve their mental health, and work through challenges. If you’re feeling overwhelmed, stuck, or struggling with your emotions, therapy can be a helpful step.",
        },
        {
          question: "Is counseling confidential?",
          answer:
            "Yes, counseling is confidential. All personal information shared during sessions is kept private, except in rare situations where there is a risk of harm to yourself or others, in which case the counselor may need to break confidentiality.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            " Simply visit our <b>Book Your Session</b> page, select your preferred therapy type, choose a date and time, and follow the easy steps to confirm your appointment.",
        },
        {
          question: "What happens if I miss my appointment?",
          answer:
            "If you miss your session, please inform us at least 24 hours in advance. In case of emergencies, contact us, and we’ll do our best to assist. The final decision will be at our discretion.",
        },
        {
          question: "Can I reschedule my session?",
          answer:
            "Yes, you can reschedule up to <b>24 hours before</b> your appointment. After this, the session may be considered a missed session, and fees may apply.",
        },
        {
          question: "How long are the sessions?",
          answer:
            "The duration of a session typically ranges from <b>45 minutes to 90 minutes</b> depending on the type of therapy you select.",
        },
        {
          question: "Can I book multiple sessions at once?",
          answer:
            "Yes, you can book multiple sessions upfront. You can also choose a regular session plan that suits your needs.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "The cost depends on the type of therapy and duration of the session. Our pricing is transparent, and you can view the costs on our <b>Book Your Session</b> page. We offer affordable rates for the quality of care provided.",
        },
        {
          question: "Do you accept insurance?",
          answer:
            "Currently, we do not accept insurance directly, but you may be able to seek reimbursement through your insurance company depending on your plan. We recommend checking with your insurance provider for coverage details.",
        },
        {
          question: "Are there payment plans available?",
          answer:
            "Yes, we offer flexible payment plans. You can choose to pay per session or select a package for multiple sessions at a discounted rate.",
        },
        {
          question: "Do I have to pay upfront?",
          answer:
            "Payment is required at the time of booking. For your convenience, we accept a variety of payment methods including credit cards, debit cards, UPI, and other digital payment options.",
        },
        {
          question: "Is there a discount for multiple sessions?",
          answer:
            "Yes, we offer discounted rates if you book a set of sessions in advance. Check our <b>Book Your Session</b> page for more details.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Simply come with an open mind. It’s helpful to think about any specific issues you want to address, but don’t worry if you’re unsure. Your therapist will guide the conversation.",
        },
        {
          question:
            "What is the difference between individual and couples therapy?",
          answer:
            "<b>Individual therapy</b> focuses on personal well-being, while <b>couples therapy</b> is aimed at improving communication, resolving conflicts, and building a stronger relationship between partners.",
        },
        {
          question: "How do I know if therapy is working?",
          answer:
            "Therapy is a gradual process. You may notice small improvements in your mood, perspective, or coping skills over time. Your therapist will also check in on progress during sessions.",
        },
        {
          question: "Can I bring a friend or family member to the session?",
          answer:
            "Generally, therapy is most effective when it’s one-on-one, but we understand if you feel more comfortable having a support person with you. Please discuss this with your therapist beforehand.",
        },
        // {
      ...
      questions: [
        {
          ...
          answer:
            "Family therapy is a form of counseling that addresses the needs of families facing issues such as communication problems, conflicts, or stress. It helps improve relationships and build a healthier family dynamic.",
        },
        {
          question: "What is parental counseling?",
          answer:
            "Parental counseling helps parents navigate parenting challenges, improve their parenting skills, and strengthen their relationships with their children, especially during difficult times.",
        },
        {
          question: "What is child and teen counseling?",
          answer:
            "This type of therapy focuses on helping children and teenagers cope with emotional challenges, behavioral issues, or developmental difficulties, providing them with tools to manage their emotions and build resilience.",
        },
        {
          question: "Do you offer group therapy?",
          answer:
            "Yes, we offer <b>group therapy</b> sessions where you can connect with others who may be experiencing similar issues, under the guidance of a trained therapist.",
        },
        {
          question: "How does couples therapy work?",
          answer:
            "Couples therapy focuses on resolving conflicts, improving communication, and rebuilding trust. It helps both partners understand each other's perspectives and find healthy ways to address disagreements.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "After your session, reflect on what was discussed, and implement any coping strategies or suggestions provided by your therapist. Journaling or practicing new techniques between sessions can also help.",
        },
        {
          question: "Will I need ongoing therapy?",
          answer:
            "The need for ongoing therapy depends on the progress and the goals you have set with your therapist. Some clients benefit from short-term therapy, while others prefer longer-term support.",
        },
        {
          question: "Can I talk to my therapist between sessions?",
          answer:
            "We encourage you to use the strategies discussed in your sessions. However, if something urgent arises, you can reach out for support, and we’ll try to assist you as needed.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "If you encounter technical difficulties, let your therapist know immediately. We will work to resolve the issue, and if necessary, reschedule or offer a phone session as an alternative.",
        },
        {
          question: "Do I need to download any software for video therapy?",
          answer:
            "No special software is required for video sessions. We use a secure platform that works directly from your web browser, ensuring ease of use.",
        },
        {
          question: "Can I use my mobile phone for therapy?",
          answer:
            "Yes, you can use your smartphone, tablet, or computer for online therapy. Ensure you have a stable internet connection for the best experience.",
        },
        {
          question: "Do I need a webcam and microphone for online sessions?",
          answer:
            "Yes, for video therapy, a working webcam and microphone are necessary. If you’re having trouble with the tech, let us know, and we’ll help you set it up.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "We use a secure and encrypted platform to ensure your privacy during online sessions. Your personal information is stored safely and only shared when necessary, as per confidentiality guidelines.",
        },
        {
          question: "Will anyone else have access to my therapy records?",
          answer:
            "No, your therapy records are kept confidential. Only authorized personnel will have access if required by law or with your explicit consent.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "Yes, you can book a session for a loved one with their consent. However, the individual must be aware and ready for therapy to be effective.",
        },
        {
          question: "How do I track my progress in therapy?",
          answer:
            "Your therapist will regularly check in on your progress and review any goals you’ve set. You can also track changes in how you feel, your coping skills, or improvements in relationships.",
        },
        {
          question: "What if I don’t feel comfortable with my therapist?",
          answer:
            "It’s important to feel comfortable with your therapist. If you ever feel that your therapist isn’t the right fit, you can request a different one.",
        },
        {
          question: "How long does it take to see results from therapy?",
          answer:
            "Every person’s journey is different. Some may feel improvements after a few sessions, while others may take longer. It’s important to trust the process and communicate with your therapist about your concerns.",
        },
      ],
    },
  ];
  ...
  return (
    <main>
      <section className="bg-white">
        <div className="relative flex min-h-[calc(100svh_+_0.5rem)] flex-col">
          <svg
            className="h-auto max-h-[calc(100svh_+_0.5rem)] w-full pt-[20%] md:pt-[10%] lg:pt-0"
          ...
          <div className="min-h-[30rem] flex-1 bg-[#235161] sm:min-h-0"></div>
          <div className="absolute bottom-0 left-0 right-0 top-0 flex flex-col">
            <p className="px-4 pt-[5%] text-center font-cabin text-2xl font-semibold md:text-3xl lg:text-4xl">
              &quot;Where Thoughts Find Understanding.&quot;
            </p>
            <div className="hidden flex-1 grid-cols-[auto_1fr_auto] place-items-center gap-6 p-6 xl:grid">
              <motion.div
                transition={{
                  delay: 0.1,
                }}
              ...
              >
                <p className="text-right text-2xl text-white">
                  Not sure <br /> if you <br /> need <br /> therapy?
                </p>
                <Button
                  size="lg"
                  variant="secondary"
              ...
              <div className="flex h-full flex-col">
                ...
                <div className="mx-auto grid max-w-4xl translate-y-5 grid-cols-3 justify-center gap-4">
                  <Link
                  ...
                  >
                    ...
                    >
                      <p className="text-center text-lg">Individual</p>
                      <div className="aspect-video">
                        <IndividualImg className="mx-auto h-full w-full" />
                      </div>
                    </motion.div>
                  </Link>
                  <Link
                  ...
                  >
                    <motion.div
                      ...
                      className="rounded-2xl bg-white p-6"
                    >
                      <p className="text-center text-lg">Parental</p>
                      <div className="aspect-video">
                        <ParentalImg className="mx-auto h-full w-full" />
                      </div>
                    </motion.div>
                  </Link>
                  <Link
                  ...
                  >
                    <motion.div
                      ...
                      className="rounded-2xl bg-white p-6"
                    >
                      <p className="text-center text-lg">Child & Teen</p>
                      <div className="aspect-video">
                        <ChildImg className="mx-auto h-full w-full" />
                      </div>
                    </motion.div>
                  </Link>
                </div>
                ...
                >
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                        size="lg"
                        className="z-50 min-w-[40%] rounded-2xl px-12 py-7 text-xl font-semibold transition-all hover:scale-[1.01] hover:bg-gray-950 md:px-14 md:py-8 md:text-2xl"
                      >
                        Book Your Session
                      </Button>
                    </DialogTrigger>
                    <DialogContent className="max-h-svh max-w-3xl overflow-y-scroll text-left">
                      <DialogHeader>
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-4 p-6 xl:hidden">
              <div className="grid w-full max-w-md gap-4">
                ...
                >
                  <motion.div
                    ...
                    initial={{ translateY: 50, opacity: 0 }}
                    whileInView={{ translateY: 0, opacity: 1 }}
                    className="flex justify-between gap-6 rounded-2xl bg-white p-6"
                  >
                    <div className="space-y-2">
                      <p className="text-lg">Individual</p>
                      <p className="line-clamp-2 text-sm">
                        One-on-one therapy for those facing depression, anger,
                        stress, and anxiety. Gain support in managing emotional
                        struggles, building coping skills, and regaining
                        control.
                      </p>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="line-clamp-2 text-sm">
                        Enhance your parenting skills by addressing challenges
                        like managing child and teen behavior, effective
                        discipline, improving communication, navigating
                        co-parenting, and fostering a supportive family
                        environment.
                      </p>
                    </div>
                    <div className="aspect-square size-20">
                ...
                >
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="line-clamp-2 text-sm">
                        One-on-one therapy for children and teens dealing with
                        anxiety, bullying, low self-esteem, and family
                        conflicts. A safe space for emotional support and
                        growth.
                      </p>
                    </div>
                    <div className="aspect-square size-20">
              ...
              >
                <p className="text-center text-xl text-white">
                  Not sure if you <br /> need therapy?
                </p>
                <Link href="/dashboard/quiz">
              ...
              <div className="bg-[#235161] xl:hidden">
                <motion.div
                  initial={{ translateY: 50, opacity: 0 }}
                  whileInView={{ translateY: 0, opacity: 1 }}
                  className="grid place-items-center pb-6 pt-4"
                >
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                        size="lg"
                        className="z-50 rounded-2xl px-12 py-7 text-xl font-semibold transition-all hover:scale-[1.01] hover:bg-gray-950 md:px-14 md:py-8 md:text-2xl"
                      >
                        Book Your Session
                      </Button>
                    </DialogTrigger>
      ...
      <section className="bg-xyz space-y-12 bg-emerald-50 bg-cover px-4 py-12">
        <p className="text-center text-3xl font-bold">Why Choose Us?</p>
        <div className="mx-auto grid max-w-md grid-cols-2 justify-center gap-4 md:max-w-4xl md:grid-cols-4">
          <motion.div
            transition={{
              delay: 0.05,
            }}
            initial={{ translateY: 50, opacity: 0 }}
            whileInView={{ translateY: 0, opacity: 1 }}
            className="flex flex-col items-center justify-evenly gap-2 space-y-4 rounded-xl bg-white p-8"
          >
            <div className="rounded-full bg-emerald-200 p-4">
              <UserRound size={32} strokeWidth={1.5} />
            </div>
            <p className="text-center text-lg font-bold">Expert Therapists</p>
          </motion.div>
          <motion.div
            transition={{
              delay: 0.1,
          ...
          >
            ...
            <p className="text-center text-lg font-bold">Flexible Schedules</p>
          </motion.div>
          <motion.div
            transition={{
              delay: 0.15,
          ...
          >
            ...
            <p className="text-center text-lg font-bold">Privacy & Security</p>
          </motion.div>
          <motion.div
            transition={{
              delay: 0.2,
            ...
            initial={{ translateY: 50, opacity: 0 }}
            whileInView={{ translateY: 0, opacity: 1 }}
            className="flex flex-col items-center gap-2 space-y-4 rounded-xl bg-white p-8"
          >
            <div className="rounded-full bg-emerald-200 p-4">
              <MessagesSquare size={32} strokeWidth={1.5} />
            </div>
            <p className="text-center text-lg font-bold">24/7 Support</p>
          </motion.div>
        </div>
      </section>
      <div className="flex justify-around gap-4 bg-emerald-300/80 px-6 py-16">
        <div className="flex gap-6 break-words text-2xl">
          <p>
            <motion.span
              onViewportEnter={() => sessionsSpring.set(750)}
              onViewportLeave={() => sessionsSpring.set(162)}
              className="text-4xl font-bold"
            >
              {sessionsCount}
            </motion.span>
            <span className="pl-1 pr-2 text-4xl">+</span>
            Sessions
          </p>
          <p>
            <motion.span
              onViewportEnter={() => clientsSpring.set(62)}
              onViewportLeave={() => clientsSpring.set(34)}
              className="text-4xl font-bold"
            >
              {clientsCount}
            </motion.span>
      ...
      <section className="grid place-items-center gap-8 px-4 py-16">
        <div className="flex items-center gap-2">
          <p className="font-montserrat text-highlight-700 pr-2 text-3xl font-semibold text-emerald-500 md:text-5xl">
            At
          </p>
          <svg
        ...
        <motion.div
          ...
          whileInView={{ translateY: 0, opacity: 1 }}
        >
          <Table className="mx-auto max-w-4xl rounded-xl bg-white shadow">
            {/* <TableCaption>A list of your recent invoices.</TableCaption> */}
            <TableHeader className="border-b border-black">
              <TableRow className="border-b border-black">
                <TableHead className="w-1/2 font-semibold text-black md:text-lg">
                  Key Features
                </TableHead>
                <TableHead className="w-1/4 bg-emerald-100 p-2">
                  {" "}
                  <svg
                ...
                <TableHead className="w-1/4 py-2 text-center font-semibold text-black md:text-lg">
                  {" "}
            ...
            <TableBody>
              {features.map((feature, index) => (
                <TableRow key={index}>
                  <TableCell className="font-semibold text-gray-800 md:text-[1.1rem]">
                    <motion.div
                      initial={{ translateY: 30, opacity: 0 }}
                      whileInView={{ translateY: 0, opacity: 1 }}
                      className="item-center flex gap-2 md:gap-4"
                    >
                      {feature.title}
                      <Tooltip>
                        <TooltipTrigger>
                  ...
                  <TableCell className="bg-emerald-100">
                    ...
                    >
                      {feature.our ? (
                        <Check className="mx-auto stroke-green-500" />
                      ) : (
                        <X className="mx-auto stroke-red-500" />
                      )}
                    </motion.div>
                  </TableCell>
                  <TableCell>
                    <motion.div
                      initial={{ translateY: 23, opacity: 0 }}
                      whileInView={{ translateY: 0, opacity: 1 }}
                    >
                      {feature.others ? (
                        <Check className="mx-auto stroke-green-500" />
      ...
      <section className="space-y-4 bg-emerald-100 px-4 py-10">
        ...
        <div className="mx-auto max-w-[94rem] px-2 py-6">
                ...
                <CarouselItem key={index} className="pl-2 lg:basis-1/3">
                  <div className="h-full rounded-xl bg-white p-4">
                    ...
                    <div className="text-center">
                      <p className="mt-4 text-balance px-2 text-lg">
                        <Quote className="mr-2 inline size-8 -translate-y-1 rotate-180 fill-emerald-400 stroke-none" />
                        {text}
                        <Quote className="ml-2 inline size-8 translate-y-1 fill-emerald-400 stroke-none" />
                      </p>
                    </div>
      ...
      <section className="space-y-4 px-4 py-8" id="faqs">
        <p className="text-center text-2xl font-semibold">
          Frequently Asked Questions
        </p>
        <Accordion className="mx-auto max-w-4xl" type="single" collapsible>
          {FAQs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index + 1}`}>
              ...
              <AccordionContent>
                <Accordion
                  className="mx-auto max-w-4xl rounded-md bg-neutral-200/50 px-4"
                  type="single"
                  collapsible
                >
