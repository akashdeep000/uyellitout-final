...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <header
        className={cn(
          "z-[1000] flex items-center justify-between gap-2 px-2 py-4 md:px-[3%] lg:px-[5%]",
          pathName.split("/")[1] ? "" : ""
        )}
      >
        <Link href="/">
        ...
        <nav className="hidden gap-3 font-semibold lg:flex">
          <ul className="transition-all hover:text-foreground hover:underline">
            <Link href="/">Home</Link>
          </ul>
          <ul className="transition-all hover:text-foreground hover:underline">
        ...
        <div className="flex items-center gap-2">
          {session?.data?.user ? (
            <Link href="/dashboard">
              <Button className="md:text-md rounded-3xl border-foreground bg-emerald-500 px-3 py-1.5 font-semibold">
                Go to Dashboard
              </Button>
            </Link>
          ) : (
            <>
              <Link href="/login">
                <Button
                  variant="outline"
                  className="md:text-md rounded-3xl border-foreground bg-inherit px-3 py-1.5 font-semibold"
                >
                  Login
                </Button>
              </Link>
      ...
      <footer
        className={cn(
          "px-4 pb-6 pt-12",
          pathName.split("/")[1] ? "bg-neutral-200" : "bg-emerald-200"
        )}
      >
        <div className="flex justify-between gap-12">
          <div className="space-y-2">
            ...
            <p className="max-w-lg text-sm text-gray-700">
              Our services do not provide crisis intervention or emergency
              mental health support. If you&apos;re in crisis, please seek
              in-person help from a licensed professional or a crisis helpline.
            </p>
          </div>
          <div>
            <nav className="flex max-w-prose flex-wrap justify-end gap-4 font-semibold">
              <ul className="transition-all hover:text-foreground hover:underline">
                <Link href="/">Home</Link>
              </ul>
              <ul className="transition-all hover:text-foreground hover:underline">
        ...
        <footer className="text-md mt-8 text-center">
